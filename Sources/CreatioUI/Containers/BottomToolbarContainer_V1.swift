//
//  BottomToolbarContainer_v1.swift
//  
//
...
public struct BottomToolbarContainer_V1<Content: View, Toolbar: View>: View, KeyboardReadable {
...
struct BottomToolbarContainer_V1_Previews: PreviewProvider {
    
    struct Preview: View {
        @State private var input = ""
        
        var body: some View {
            BottomToolbarContainer_V1 {
                VStack {
                    ForEach(0..<30) { i in
